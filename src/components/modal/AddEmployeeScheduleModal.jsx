...
const AddEmployeeScheduleModal = ({
  ...
  onFinish,
  selectedDate,
  selectedEmployee, // New prop for pre-selected employee
  managedShifts, // Pass managed shifts definitions
  ...
  const employeeOptions = employees?.map(emp => ({ 
    ...
    value: emp.name, // Assuming 'name' is used as the identifier/value
    label: emp.name // Assuming 'name' is used for display label
  })) || []; // Default to empty array if employees is null/undefined
  // --- End prepare options ---
